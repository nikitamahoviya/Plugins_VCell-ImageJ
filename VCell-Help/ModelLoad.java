...
@Plugin(type = Command.class, label = "VCell-ImageJ Template-Example",  iconPath="sim_new.gif",menu = {
		@Menu(label = MenuConstants.PLUGINS_LABEL, weight = MenuConstants.FILE_WEIGHT,
			mnemonic = MenuConstants.FILE_MNEMONIC),
		@Menu(label = "VCell Help",  weight = 4, mnemonic = 'V'),
		@Menu(label = "VCell-ImageJ Template-Example", weight = 30,
			mnemonic = 'e',accelerator = "^E") },  attrs = { @Attr(name = "no-legacy") })
