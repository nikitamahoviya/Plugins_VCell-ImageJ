...
@Plugin(type = Command.class, label = "Line Plot",  iconPath="app_fitting.gif",menu = {
		...
		@Menu(label = "Line Plot", weight = RecentFileService.MAX_FILES_SHOWN + 10,
			mnemonic = 'p',accelerator = "^P") },  attrs = { @Attr(name = "no-legacy") })
