...
@Plugin(type = Command.class, label = "VCell Model Search",  iconPath="search_icon.gif",menu = {
		...
		@Menu(label = "VCell Model Search", weight = RecentFileService.MAX_FILES_SHOWN + 10,
			mnemonic = 'm',accelerator = "^M") },  attrs = { @Attr(name = "no-legacy") })
